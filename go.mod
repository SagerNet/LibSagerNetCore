...
replace github.com/v2fly/v2ray-core/v5 => github.com/sagernet/v2ray-core/v5 v5.0.11-0.20220601013542-d6195c5adadb
...
require (
	...
	github.com/sagernet/sing v0.0.0-20220601012415-1cb90977f9d0 // indirect
